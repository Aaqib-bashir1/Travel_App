...
//   const initialPosition = { lat: 34.1526, lng: 77.5771 };
...
//               mediaFormData.append('content_type', 'trips.trip'); // Replace with your actual content type
//               mediaFormData.append('object_id', createdTrip.id);
...
//         setTripCreated(true);
//         setTimeout(() => navigate(`/my-trips/${createdTrip.id}/edit`), 2000);
//       }
//     } catch (err) {
...
//           <button onClick={() => navigate(`/trips/${tripId}/edit`)}>
//             Edit Trip
//           </button>
//         </div>
//       )}
          ...
          try {
            await Promise.all(media.map(async (mediaItem) => {
              if (mediaItem.file) {
                ...
                mediaFormData.append('media_type', mediaItem.type);
                mediaFormData.append('caption', mediaItem.caption);
                mediaFormData.append('content_type', 'trips.trip');
                mediaFormData.append('object_id', createdTrip.id);
